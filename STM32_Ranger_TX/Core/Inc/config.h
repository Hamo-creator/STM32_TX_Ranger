...
//const int analogInPinAileron = A2;  //PinAileron_Pin
//const int analogInPinElevator = A3;  //PinElevator_Pin
//const int analogInPinThrottle = A1;  //PinThrottle_Pin
//const int analogInPinRudder = A0;   //PinRudder_Pin
//const int VOLTAGE_READ_PIN = A7;    //VOLTAGE_READ_PIN_Pin

// pins that used for the switch
//const int DIGITAL_PIN_SWITCH_ARM = 4;  // Arm switch SWITCH_ARM_Pin
//const int DIGITAL_PIN_SWITCH_AUX2 = 3; //SWITCH_AUX2_Pin
//const int DIGITAL_PIN_SWITCH_AUX3 = 2;  //SWITCH_AUX3_Pin
...
//const int DIGITAL_PIN_SWITCH_AUX4 = 0;  // Set to 0 to disable this input  SWITCH_AUX4_Pin
